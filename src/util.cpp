...
int nAnonymizeSwapCashAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\SwapCash
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\SwapCash
    // Mac: ~/Library/Application Support/SwapCash
    // Unix: ~/.SwapCash
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "SwapCash";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "SwapCash.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "swapcashd.pid"));
